...
SYMBOLS = [
    ...
    '1000SHIB/USDT', '1000FLOKI/USDT', '1000BONK/USDT', 'WIF/USDT', 'RENDER/USDT'
]
...
# Risk Config
MAX_POSITIONS = 15 # Focused portfolio
LEVERAGE_CAP = 12 # High Leverage for fast growth
RISK_PER_TRADE = 0.025 # Aggressive sizing (2.5%)
COOLDOWN_MINUTES = 5 # Fast re-entry
CIRCUIT_BREAKER_DRAWDOWN = 0.30 # Strict safety net
